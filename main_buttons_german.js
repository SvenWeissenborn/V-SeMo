...
let text_1 = new fabric.Text("Alle Geodäten löschen", {
    fontSize: textSize,
...
let text_2 = new fabric.Text("Sektoren zurücksetzen", {
    fontSize: textSize,
    fontFamily: 'Helvetica',
...
let text_3 = new fabric.Text("Sektoren greifen [G]", {
    fontSize: textSize,
    fontFamily: 'Helvetica',
...
let text_4 = new fabric.Text("Geodäten zeichnen [Z]", {
    fontSize: textSize,
    fontFamily: 'Helvetica',
...
let text_5 = new fabric.Text("Geodäten: rückgängig [R]", {
    fontSize: textSize,
    fontFamily: 'Helvetica',
...
let text_6 = new fabric.Text("Geodätenelemente löschen", {
    fontSize: textSize,
    fontFamily: 'Helvetica',
