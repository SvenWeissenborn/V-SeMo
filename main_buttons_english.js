...
let text_1 = new fabric.Text("Delete all geodesics", {
    fontSize: textSize,
...
let text_2 = new fabric.Text("Reset sectors", {
    fontSize: textSize,
    fontFamily: 'Helvetica',
...
let text_3 = new fabric.Text("Drag/Extend [G]", {
    fontSize: textSize,
    fontFamily: 'Helvetica',
...
let text_4 = new fabric.Text("New geodesic [Z]", {
    fontSize: textSize,
    fontFamily: 'Helvetica',
...
let text_5 = new fabric.Text("Geodesics: Undo [R]", {
    fontSize: textSize,
    fontFamily: 'Helvetica',
...
let text_6 = new fabric.Text("Remove geodesic element", {
    fontSize: textSize,
    fontFamily: 'Helvetica',
